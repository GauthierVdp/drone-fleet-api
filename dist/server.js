...
const database_1 = __importDefault(require("./core/config/database")); // Ensure the database connection is established
const droneRoutes_1 = __importDefault(require("./rest/routes/droneRoutes")); // Import the drone routes
